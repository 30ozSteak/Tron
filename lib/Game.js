...
module.exports = class Game {
  constructor(ctx) {
    ...
    this.lives = 3;
    this.blocks = [
      new Block(25, 270, 20, 20, 'rgb(255, 255, 81)', 1, 0),  //yellow, left side
      new Block(580, 270, 20, 20, 'rgb(0, 153, 255)', -1, 0), //blue, right side
    ];
    this.tail = [];
  }
  ...
  metaPlayer(block) {
    ...
    if (block.isCollidingWithWall(canvas.width, canvas.height)) {
      ...
      this.endGame(block);
      // this doesnt worororkrkrkrkkrkrk;
  ...
  handleKeyPress(e) {
    ...
    // change to switch statement, just to match previous project?
